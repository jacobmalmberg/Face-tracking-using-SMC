...
To track the movements of the face, the particles are first propagated. The particles are then given weights according to how similar the color in the neighbourhood of the particle is to the color of the face. The particles are then sampled from this weight distribution. The mean of the sampled particles is then taken to get an estimate of the position of the face.

By updating the color histogram of the face over the progression of the movie, changes in the lighting conditions can be handled without losing track of the face. 

The project builds on the work of Nummiaro (2001) as well as Wang et al. (2019). More information can be found in the report and in the references section below.
...
<p align="center">
<img src="https://github.com/jacobmalmberg/Face-tracking-using-SMC/blob/master/gifs/size-change-blue-background.gif
" width = "60%"/>
</p>
